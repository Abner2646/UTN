class Atleta:
    ...
    def entrenar(self) -> None:
        '''Cuando un atleta entrena, consume 5 unidades de energía. Cada cinco entrenamientos,
        el atleta mejora en 1 punto su destreza, que al crearse comienza con su valor en el mínimo predeterminado.'''
    ...
    def descansar(self) -> None:
        ...
        if self.__energia >= 95:
            print("Energía actualizada al máximo!")
            self.__energia = self.__class__.__MAX_VALOR
        else:
            self.__energia += 20
            print(f"Energía actual: {self.__energia}")
    ...
    def toString(self):
        return (f"Estado actual: Nombre: {self.__nombre}, Destreza: {self.__destreza}, Energía: {self.__energia}")
...
class Tester:
    ...
    def testearTodo():
        ...
        print(f"Energía: {a1.obtenerEnergia()}")
